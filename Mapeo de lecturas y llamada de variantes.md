...
El análisis de datos de secuenciación de nueva generación (Next Generation Sequencing, NGS) constituye uno de los pilares de la genómica moderna. El enorme volumen de información generado por estas tecnologías requiere algoritmos computacionales especializados capaces de transformar millones de lecturas cortas en información biológicamente interpretable. Entre las etapas más importantes de este proceso se encuentran el alineamiento de lecturas contra un genoma de referencia y el llamado de variantes, procedimientos que permiten identificar diferencias genéticas entre individuos, poblaciones o especies.

En un flujo de análisis típico de datos NGS, las lecturas obtenidas por el secuenciador son sometidas inicialmente a un control de calidad para eliminar adaptadores, secuencias contaminantes y bases de baja calidad. Posteriormente, las lecturas filtradas se alinean contra un genoma de referencia mediante algoritmos de mapeo especializados, generando archivos de alineamiento que posteriormente sirven como entrada para herramientas de descubrimiento de variantes. Finalmente, las variantes detectadas son filtradas y anotadas antes de ser utilizadas en estudios de diversidad genética, genética de poblaciones, evolución, selección natural o mejoramiento genético.

Debido a la importancia de estas etapas, en este capítulo se describen los fundamentos biológicos, estadísticos y computacionales del alineamiento de lecturas y del llamado de variantes, haciendo énfasis en las herramientas Bowtie2 y GATK, ampliamente utilizadas en proyectos de resecuenciación genómica.
